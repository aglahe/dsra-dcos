...
docker run --name bamboo -t --rm -p 8000:8000 -p 80:80 \
                               -v /home/core/dsra-dcos/docker/bamboo/haproxy_template.cfg:/opt/go/src/github.com/QubitProducts/bamboo/config/haproxy_template.cfg \
                               ...
                               hub.dsra.local:5000/dsra/bamboo:0.2.16.4
